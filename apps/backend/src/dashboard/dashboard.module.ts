...
import { VENCIMIENTOS_PROXIMOS_VIEW, VENCIMIENTOS_POR_ESTADO_VIEW, PROXIMOS_VENCIMIENTOS_DETALLE_VIEW, ACTIVIDAD_RECIENTE_VENCIMIENTOS_VIEW } from '../obligaciones/application/public-views';
...
import { TAREAS_PENDIENTES_VIEW, CARGA_TRABAJO_VIEW, ACTIVIDAD_RECIENTE_TAREAS_VIEW } from '../tareas/application/public-views';
...
@Module({
  imports: [JwtModule.register({}), ClientesModule, ObligacionesModule, TareasModule, FacturacionModule, IamModule],
