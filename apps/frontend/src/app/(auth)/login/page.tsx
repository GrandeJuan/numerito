...
function LoginPageContent() {
  ...
  return (
    <main className="flex min-h-screen bg-[#faf8ff] text-[#131b2e] antialiased">
      ...
      <div className="w-full lg:w-[40%] flex flex-col p-6 sm:p-8 md:p-12 lg:p-16 justify-between relative z-10">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div className="space-y-5">
              <div className="flex flex-col space-y-1.5">
                <label
                  className="text-[10px] font-bold uppercase tracking-widest text-[#45474c]"
                  htmlFor="email"
                >
                  Email
                </label>
            ...
            <div className="flex items-center justify-between">
              ...
              <Link
                className="text-xs font-semibold text-[#00a472] hover:underline"
        ...
        <footer className="flex justify-between items-center text-[9px] uppercase tracking-widest font-bold text-[#75777d] mt-8 lg:mt-0">
          ...
          <div className="flex gap-4">
            <a className="hover:text-[#131b2e] transition-colors" href="/privacy">
              Privacidad
            </a>
            <a className="hover:text-[#131b2e] transition-colors" href="/support">
              Soporte
            </a>
          </div>
        </footer>
      ...
      <div
        className="hidden lg:flex lg:w-[60%] relative overflow-hidden items-center justify-center"
        style={{ background: 'radial-gradient(circle at center, #1e293b 0%, #091426 100%)' }}
      >
        <div
          ...
          <div className="relative mb-16 w-full aspect-[4/3] flex items-center justify-center">
            ...
            >
              <path
                ...
                d="M120 225 C 200 225, 250 120, 300 120"
                stroke="#4edea3"
                strokeOpacity="0.3"
                strokeWidth="2"
              />
              <path
                className="dash-animation"
                d="M120 225 C 200 225, 250 330, 300 330"
                stroke="#4edea3"
                strokeOpacity="0.3"
                strokeWidth="2"
              />
              <path
                className="dash-animation"
                d="M480 225 C 400 225, 350 120, 300 120"
                stroke="#4edea3"
                strokeOpacity="0.3"
                strokeWidth="2"
              />
              <path
                className="dash-animation"
                d="M480 225 C 400 225, 350 330, 300 330"
                stroke="#4edea3"
                strokeOpacity="0.3"
                strokeWidth="2"
              />
              ...
              <path
                d="M472 234C472 229 475.582 228 480 228C484.418 228 488 229 488 234"
                stroke="#4edea3"
                strokeWidth="1.5"
              />
        ...
        <div className="absolute bottom-12 right-12 flex items-center gap-3 bg-white/5 backdrop-blur-md px-5 py-3 rounded-2xl border border-white/10">
          ...
          <p className="text-white/80 text-[10px] font-bold uppercase tracking-widest">
            Sincronización con ARCA: Activa
          </p>
        </div>
      </div>
